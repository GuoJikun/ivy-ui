class IvyIconLocationInformation extends HTMLElement {
      ...
      function install(){
        if(window.customElements.get('ivy-icon-location-information')) return;
        window.customElements.define('ivy-icon-location-information', IvyIconLocationInformation);
      }
