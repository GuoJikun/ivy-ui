import { findElementsDownward, buildShadowRoot } from "../../../ivy-ui/src/utils/assist";
import { $_color_primary } from "../../../ivy-ui/src/utils/var";
...
export class Breadcrumb extends HTMLElement {
    ...
    render(separator: string) {
        ...
        if (stepList && stepList.length) {
            stepList.map((co: HTMLElement, i: number) => {
