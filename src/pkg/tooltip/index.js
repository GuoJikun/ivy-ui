...
class Tooltip extends HTMLElement {
  ...
  constructor() {
    ...
    this.contentSlot = this._shadowRoot.querySelector(
      ".ivy-tooltip-content-slot"
    );
      ...
      (ev) => {
        ...
        if (/^(top|bottom)/.test(placement)) {
          ...
          if (/-left$/.test(placement)) {
            ...
            this.ctx.style.left =
              -(parseFloat(sliderWidth) - parseFloat(width)) / 2 + "px";
          }
        } else {
          ...
          if (/-top$/.test(placement)) {
            ...
            this.ctx.style.top =
              -(parseFloat(sliderHeight) - parseFloat(height)) / 2 + "px";
          }
        }
