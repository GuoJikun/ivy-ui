...
class Input extends HTMLElement {
  constructor() {
    ...
    this.preIconInner = this._shadowRoot.querySelector(
      ".ivy-input-icon-prefix ivy-icon"
    );
    this.sufIcon = this._shadowRoot.querySelector(".ivy-input-icon-suffix");
    this.sufIconInner = this._shadowRoot.querySelector(
      ".ivy-input-icon-suffix ivy-icon"
    );
