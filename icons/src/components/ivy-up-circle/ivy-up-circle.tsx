...
@Component({
  tag: "ivy-up-circle",
  styleUrl: 'ivy-up-circle.css',
  shadow: true,
})
export class IvyUpCircle {
  @Prop({
    attribute: 'size',
    mutable: true,
    reflect: true,
